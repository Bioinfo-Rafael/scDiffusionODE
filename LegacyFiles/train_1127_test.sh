#!/bin/bash
# MINIMAL TEST VERSION - Auto Training and Sampling Script (20251127)
# Automatically passes training results to sampling
# *** THIS IS A MINIMAL TEST VERSION FOR QUICK VALIDATION ***

set -e  # Exit on any error

echo "=========================================="
echo "MINIMAL TEST - Auto Training & Sampling Script (20251127)"
echo "*** WARNING: This is a minimal test version ***"
echo "=========================================="
...
# Training parameters (MINIMIZED FOR TESTING)
DATA_DIR="/home/suzuki/Projects/scDiffusion/data_preparation/pbmc68k.h5ad"
LR_ANNEAL_STEPS=50      # CHANGED: 3000 -> 50 (60x faster)
SAVE_INTERVAL=25        # CHANGED: 500 -> 25 (save more frequently for test)
LOG_INTERVAL=10         # CHANGED: 100 -> 10 (more frequent logging)
BATCH_SIZE=4            # CHANGED: 32 -> 4 (reduce memory usage)
DIFFUSION_STEPS=1000    # SAME: keep original
LR="5e-6"               # SAME: keep original
ODE_REG_LAMBDA="0.005"  # SAME: keep original

# Sampling parameters (MINIMIZED FOR TESTING)
NUM_SAMPLES=20          # CHANGED: 500 -> 20 (25x faster)
SAMPLE_BATCH_SIZE=10    # CHANGED: 50 -> 10 (smaller batches)

echo "MINIMAL TEST PARAMETERS:"
echo "  Training steps: ~$LR_ANNEAL_STEPS (vs 3000 original)"
echo "  Batch size: $BATCH_SIZE (vs 32 original)"
echo "  Sample count: $NUM_SAMPLES (vs 500 original)"
echo "  Expected time: ~2-3 minutes (vs 50+ minutes original)"
echo ""
...
echo ""
echo "MINIMAL training completed! Extracting model information..."
...
echo ""
echo "Starting MINIMAL sampling with trained model..."

# Determine preprocessed data path
PREPROCESSED_DATA_DIR="data_preparation/pbmc68k_preprocessed_zscore_hvg1024_20251105.h5ad"

# Create sampling output filename (with TEST marker)
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
SAMPLE_DIR="output/simulated_samples/TEST_${MODEL_NAME}_${TOTAL_STEPS}steps_${NUM_SAMPLES}samples_${TIMESTAMP}.npz"
...
echo ""
echo "MINIMAL sampling completed! Extracting sample information..."
...
echo "=========================================="
echo "MINIMAL TEST PIPELINE COMPLETED SUCCESSFULLY"
echo "=========================================="
echo "Training Results:"
echo "  ✓ Model saved to: $TRAINED_MODEL_PATH"
echo "  ✓ Training steps: $TOTAL_STEPS (MINIMAL TEST)"
echo "  ✓ Model directory: $MODEL_DIR"
echo ""
echo "Sampling Results:"
echo "  ✓ Samples saved to: $SAMPLE_FILE_PATH"
echo "  ✓ Number of samples: $NUM_SAMPLES_ACTUAL (MINIMAL TEST)"
...
echo ""
echo "Starting MINIMAL visualization analysis..."
...
echo ""
echo "=========================================="
echo "MINIMAL TEST PIPELINE FINISHED SUCCESSFULLY"
echo "=========================================="
echo "Training Results:"
echo "  ✓ Model saved to: $TRAINED_MODEL_PATH"
echo "  ✓ Training steps: $TOTAL_STEPS (MINIMAL TEST)"
...
echo "  ✓ Parameter distributions: ${VIZ_OUTPUT_DIR}/parameter_distributions.png"
...
echo "*** MINIMAL TEST COMPLETE *** - Pipeline execution finished at $(date)"
echo "*** If test successful, use ./train_1127.sh for full execution ***"