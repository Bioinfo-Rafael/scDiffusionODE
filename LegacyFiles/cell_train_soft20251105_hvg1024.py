...
def main():
    ...
    sc.pp.highly_variable_genes(
        adata,
        n_top_genes=1024,         # HVG 1024遺伝子を使用 (20251105版)
    ...
    preprocessed_path = args.data_dir.replace('.h5ad', '_preprocessed_zscore_hvg1024_20251105.h5ad')
...
def create_argparser():
    defaults = dict(
        ...
        model_name="pbmc68k_soft_20251105_hvg1024",  # HVG 1024 version (20251105)
        save_dir='output/diffusion_checkpoint_soft_hvg1024_20251105',  # HVG 1024 version (20251105)
        ode_reg_lambda=0.005,   # デフォルト値
