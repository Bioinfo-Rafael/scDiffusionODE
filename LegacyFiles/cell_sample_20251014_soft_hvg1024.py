...
# -*- coding: utf-8 -*-
"""
Generate a large batch of cell samples from a trained hybrid diffusion model (Soft HVG1024 version 20251014).

【Soft制約 HVG1024版】
- ODEモデル + Cell_Unetのハイブリッドモデル (ODE-ML Hybrid) を使用
- cell_train_soft20251014_hvg1024.py で学習したモデルを使用
- HVG処理により1024遺伝子に削減
- 学習時と同一の前処理 (_preprocessed_zscore_hvg1024.h5ad) を利用



CUDA_VISIBLE_DEVICES="" python /home/suzuki/Projects/scDiffusion/cell_sample_20251014_soft_hvg1024.py \
    --model_path /home/suzuki/Projects/scDiffusion/output/checkpoint/backbone_NoConstraint_hvg1024/pbmc68k_NoConstraint_20251014_hvg1024/model002000.pt \
    --data_dir /home/suzuki/Projects/scDiffusion/data_preparation/pbmc68k_preprocessed_zscore_hvg1024.h5ad
を実行
...
def create_argparser():
    defaults = dict(
        ...
        sample_dir="/home/suzuki/Projects/scDiffusion/output/simulated_samples/pbmc68k_soft_20251014_hvg1024_500samples.npz",
    )
