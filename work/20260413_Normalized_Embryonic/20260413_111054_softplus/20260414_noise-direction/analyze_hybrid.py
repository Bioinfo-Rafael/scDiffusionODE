        ...
        for t in timesteps:
            ...
            for x0_cpu, cond_cpu in subset:
                ...
                for _ in range(args.num_noise_draws):
                    ...
                    # hybrid forward と同じく各枝を L2 normalize
                    ...
                    # weighted 側は「正規化後に内分比を掛けた値」
                    ode_contrib = effective_r * ode_unit
                    ml_contrib  = (1.0 - effective_r) * ml_unit
...
def build_parser() -> argparse.ArgumentParser:
    ...
    defaults = dict(
        ...
        model_path="/home/suzuki/Projects/scDiffusion/work/20260413_Normalized_Embryonic/20260413_111054_softplus/20260413_111056_train/checkpoints/pbmc68k_soft_20251127_hvg1024/ema_0.9999_050000.pt",
