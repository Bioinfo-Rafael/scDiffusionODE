#!/usr/bin/env python3
"""Train one isolated 20260817 single-ODE condition with safe segmented resume."""
...
def run_training(args: argparse.Namespace) -> int:
    ...
    update_manifest(
        run_dir,
        schema_version="20260817_singleODE",
        experiment=experiment,
    ...
    try:
        ...
        model_name = str(config.get("model_name", "single_ode_direct_hill_20260817"))
