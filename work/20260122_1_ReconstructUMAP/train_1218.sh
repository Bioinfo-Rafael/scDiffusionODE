...
TRAIN_SCRIPT="${WORK_DIR}/cell_train_soft20251106_hvg1024.py"
SAMPLE_SCRIPT="${WORK_DIR}/cell_sample_20251106_soft_hvg1024.py"
VISUALIZATION_SCRIPT="${WORK_DIR}/visualization_analysis.py"

# Data path (preprocessed data used for both training and sampling)
DATA_DIR="/home/suzuki/Projects/scDiffusion/work/20260122_1_ReconstructUMAP/pbmc68k_preprocessed_20260122.h5ad"
SAMPLE_NAME="pbmc68k.npz"

# Training parameters (matching train_20251106_soft.sh)
LR_ANNEAL_STEPS=100000  # Fixed: was 1000, now matches train_20251106_soft.sh
SAVE_INTERVAL=5000
LOG_INTERVAL=100
BATCH_SIZE=128
