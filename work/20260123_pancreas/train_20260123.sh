...
TRAIN_SCRIPT="${WORK_DIR}/cell_train_soft20260123_hvg1024.py"
SAMPLE_SCRIPT="${WORK_DIR}/cell_sample_20260123_soft_hvg1024.py"
VISUALIZATION_SCRIPT="/home/suzuki/Projects/scDiffusion/work/20260122_1_ReconstructUMAP/visualization_analysis.py"

# Data path (preprocessed data used for both training and sampling)
DATA_DIR="/home/suzuki/Projects/scDiffusion/work/20260123_pancreas/pancreas_preprocessed_20260123.h5ad"
EDGE_TSV_PATH="/home/suzuki/Projects/scDiffusion/external_data/Mouse_tf_target_edges.tsv"
SAMPLE_NAME="pancreas.npz" #"pbmc68k.npz"
