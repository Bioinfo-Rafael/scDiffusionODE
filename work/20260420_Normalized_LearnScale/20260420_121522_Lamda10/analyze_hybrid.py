#!/usr/bin/env python3
"""
For selected timesteps t, it computes

    ode_raw = ode_model(x_t)
    ml_raw  = ml_model(x_t, scaled_t, y)

    ode_unit = normalize(ode_raw)
    ml_unit  = normalize(ml_raw)
    r_t      = scheduler(scaled_t)
    scale    = scale_net(x_t, scaled_t, T, ode_raw, ml_raw)

    ode_contrib = scale * r_t * ode_unit
    ml_contrib  = scale * (1-r_t) * ml_unit
    hybrid_pred = ode_contrib + ml_contrib

and compares them against the true Gaussian noise eps.
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    defaults = dict(
        ...
        model_path="/home/suzuki/Projects/scDiffusion/work/20260420_Normalized_LearnScale/20260420_121522_Lamda10/20260420_121525_train/checkpoints/pbmc68k_soft_20251127_hvg1024/ema_0.9999_030000.pt",
