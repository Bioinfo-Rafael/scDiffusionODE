...
class OfflineHybridAnalyzer:
    def __init__(self, args: argparse.Namespace):
        ...
        from ODE.ode_20260421_regODEMLratio import GeneODE, ODE_ML_Hybrid
        ...
        for t in timesteps:
            ...
            for x0_cpu, cond_cpu in subset:
                ...
                for _ in range(args.num_noise_draws):
                    ...
                    # Reproduce the same branch decomposition as the trained hybrid model.
                    ...
                    ode_contrib = effective_r * ode_raw
                    ml_contrib = (1.0 - effective_r) * ml_raw
                    ...
                    hybrid_direct = model(x_t, model_t, **cond)
                    recompose_err = flatten_norm(hybrid_direct - hybrid_pred)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    defaults = dict(
        ...
        model_path="/home/suzuki/Projects/scDiffusion/work/20260421_RegODEMLratio/20260421_120748_default/20260421_120750_train/checkpoints/pbmc68k_soft_20251127_hvg1024/ema_0.9999_030000.pt",
