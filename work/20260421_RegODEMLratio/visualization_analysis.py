...
def main():
    ...
    if args.data_dir:
        ...
        adata_real.obs['final_annotation'] = adata_real.obs["celltype"].astype(str).astype("category")
        ...
        if not args.skip_umap:
            ...
            edge_tsv = "/home/suzuki/Projects/scDiffusion/external_data/Mouse_tf_target_edges.tsv"
