...
import numpy as np
import torch
from ..common import finite, new_dir, write_csv, write_json
...
def sample_to_disk(
    ...
    for name in ("pred_xstart", "epsilon", "cellunet_raw"):
    ...
    metadata = {
        **provenance,
        ...
        "diffusion_outputs_semantics": "pred_xstart, epsilon, cellunet_raw, ode_raw use INPUT to the saved diffusion update; columns 0..19",
            ...
            for start in range(0, count, batch_size):
                ...
                for step in range(1, 1001):
                    ...
                    if step % 50 == 0:
                        ...
                        eps = branches["output"] if hybrid else branches["ml_raw"]
                        values = {
